...
export default function OeuvreNouvelleVague(props) {
                      ...
                      <Zoom>
                        <img
                          src={artiste.fields.illustrationOeuvre1[
                            i
                          ].fields.file.url.replace("http", "https")}
                          alt="Picture of the author"
                        // width="600"
                        //  height="600"
                        className="tailleImage"
          ...
          <div className="keen-slider__slide">
            {isPageWide ? (
              artiste.fields.illustrationOeuvre3 && (
                <Zoom>
                  <img
                    src={artiste.fields.illustrationOeuvre3[0].fields.file.url.replace(
                      "http",
                      "https"
                    )}
                    alt="Picture of the author"
              ...
              >
                {artiste.fields.illustrationOeuvre3?.map((oeuvre, i) => (
                  <Carousel.Item key={i}>
                    <Zoom>
                      <img
                        src={artiste.fields.illustrationOeuvre3[i].fields.file.url.replace(
                          "http",
                          "https"
                        )}
                        alt="Picture of the author"
          ...
          <div className="keen-slider__slide">
            {isPageWide ? (
              artiste.fields.illustrationOeuvre4 && (
                <Zoom>
                  <img
                    src={artiste.fields.illustrationOeuvre4[0].fields.file.url.replace(
                      "http",
                      "https"
                    )}
                    alt="Picture of the author"
              ...
              >
                {artiste.fields.illustrationOeuvre4?.map((oeuvre, i) => (
                  ...
                  /> */}
                      <img
                        src={artiste.fields.illustrationOeuvre4[i].fields.file.url.replace(
                          "http",
                          "https"
                        )}
                        alt="Picture of the author"
          ...
          <div className="keen-slider__slide">
            {isPageWide ? (
              artiste.fields.illustrationOeuvre5 && (
                <Zoom>
                  <img
                    src={artiste.fields.illustrationOeuvre5[0].fields.file.url.replace(
                      "http",
                      "https"
                    )}
                    alt="Picture of the author"
              ...
              >
                {artiste.fields.illustrationOeuvre5?.map((oeuvre, i) => (
                  <Carousel.Item key={i}>
                    <Zoom>
                      <img
                        src={artiste.fields.illustrationOeuvre5[i].fields.file.url.replace(
                          "http",
                          "https"
                        )}
                        alt="Picture of the author"
          ...
          <div className="keen-slider__slide">
            {isPageWide ? (
              artiste.fields.illustrationOeuvre6 && (
                <Zoom>
                  <img
                    src={artiste.fields.illustrationOeuvre6[0].fields.file.url.replace(
                      "http",
                      "https"
                    )}
                    alt="Picture of the author"
              ...
              >
                {artiste.fields.illustrationOeuvre6?.map((oeuvre, i) => (
                  <Carousel.Item key={i}>
                    <Zoom>
                      <img
                        src={artiste.fields.illustrationOeuvre6[i].fields.file.url.replace(
                          "http",
                          "https"
                        )}
                        alt="Picture of the author"
          ...
          <div className="keen-slider__slide">
            {isPageWide ? (
              artiste.fields.illustrationOeuvre7 && (
                <Zoom>
                  <img
                    src={artiste.fields.illustrationOeuvre7[0].fields.file.url.replace(
                      "http",
                      "https"
                    )}
                    alt="Picture of the author"
              ...
              >
                {artiste.fields.illustrationOeuvre7?.map((oeuvre, i) => (
                  <Carousel.Item key={i}>
                    <Zoom>
                      <img
                        src={artiste.fields.illustrationOeuvre7[i].fields.file.url.replace(
                          "http",
                          "https"
                        )}
                        alt="Picture of the author"
